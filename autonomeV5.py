...
# --- Capteurs de lumière ---
ldr_avant = ADC(2)    # GP26 (ADC0) â†’ LDR avant
ldr_arriere = ADC(0)  # GP28 (ADC2) â†’ LDR arrière
...
def comportement_lumiere():
   ...
   while True:
       ...
       if avant_val < seuil_detection and arriere_val < seuil_detection:
           print(" Lumière trop basse â†’ je cherche (tourner)")
           gauche(50)
       else:
           if avant_val > arriere_val:
               print(" Lumière devant â†’ j'avance")
               avancer(70)
           else:
               print(" Lumière derrière â†’ je recule")
               reculer(70)
